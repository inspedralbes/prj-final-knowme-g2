        ...
        <>
            <ul className="top-10 fixed">
                <li className="shadow-2xl">
                    <button onClick={() => setSelected(0)} className={"bg-[#2d2d2d] border-solid border-2 border-[#2d2d2d] w-12 h-12  rounded-xl ml-1 shadow-sm shadow-black transition-all duration-100" + (selected == 0 ? ' border-[#ffffff] ' : ' ')}> <span className="icon-[material-symbols--draw-sharp] w-8 h-8 justify-center align-middle  text-white" ></span>
                    </button>
                </li>
                <li>
                    <button onClick={() => setSelected(1)} className={"bg-[#2d2d2d] border-solid border-2 border-[#2d2d2d] w-12 h-12 mt-3 rounded-xl ml-1 shadow-sm shadow-black transition-all duration-100" + (selected == 1 ? ' border-[#ffffff] ' : ' ')}> <span className="icon-[streamline--widget] w-7 h-7 justify-center align-middle  text-white" ></span>
                    </button>
                </li>
                <li>
