    ...
    return (
        <>
            ...
            <div>
                ...
                <div id="TextComponent" className="p-2 rounded-md bg-slate-100 text-slate-900 h-32 mb-4 font-bold relative group cursor-grab active:cursor-grabbing"
                    draggable onDragStart={(evt) => startDrag(evt, "TextComponent")}>
                    <h1>Text</h1>
                    <div className="transition-all opacity-0 rounded-md group-hover:opacity-100 absolute inset-0 bg-gray-400 bg-opacity-80 flex items-center justify-center">
                        <span className="icon-[tabler--square-plus-2] size-6"></span>
                    </div>
