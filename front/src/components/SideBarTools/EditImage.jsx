...
export function EditImage() {
    ...
    const [img, setImg] = useState(content[contentIndex]?.src);
    ...
    const handlerUpload = () => {
        ...
        setContent({ src: canvas.toDataURL(), width: variables?.width, height: variables?.height, id: contentIndex })
    }
        ...
        <>
            ...
            <button className="relative font-bold text-lg w-full h-12 rounded-full bg-[#69b4ff] text-[#ffffff] hover:opacity-90 transition-all duration-100 mt-3">
                ...
                <input onInput={(event) => {
                    ...
                    setImg(srcImg);                    
                    setContent({ src: srcImg, id: contentIndex })
            ...
            <div className="flex mt-4">
                <div className="flex items-center justify-center gap-4 mb-4 ">
                    ...
                    <input type="number" min="0" max="50" value={content?.radius} onChange={(e) => setContent({ radius: e.target.value })} name="border" id="border"
                ...
                <div className="mb-4 ml-10 flex items-center">
                    ...
                    <input type="number" min="0" max="100" value={content?.border} onChange={(e) => setContent({ border: e.target.value, id: contentIndex })} name="border" id="border"
                        className=" h-7 w-12 p-1 right-0 border rounded-xl focus:outline-none text-right focus:border-blue-500 text-slate-700"
                    />
                </div>
            </div>
