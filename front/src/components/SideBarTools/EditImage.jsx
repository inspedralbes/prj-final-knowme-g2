...
export function EditImage() {
    ...
    return (
        <>
            ...
            <div className={(img ? "" : "hidden") + "flex align-middle justify-center flex-col"}>

                <AvatarEditor className=" max-w-64 max-h-64 ml-auto mr-auto border-2 border-gray-100 rounded-md overflow-hidden mt-4 mb-4 w-3/4 h-3/4"
                    ref={editor}
                    image={img}
